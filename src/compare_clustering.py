...
# RESULT_CSV = os.path.join(DATA_DIR, "clustering_comparison_results.csv")
# RESULT_PLOT = os.path.join(FIG_DIR, "clustering_comparison_plot.png")
#
...
# plt.title("📊 Сравнение кластеризаций по Silhouette Score")
